...
for (i in 1:length(region_list)){
  ...
  directory=paste0("D:/Projects/Large_scale_snRNA_seq/Brain_region_project/Brain_region_final/Evaluate_overlap_OteroGarcia/Permutation_test/nft/Overlap_results_down/",region)
setwd(directory)
...
for (i in 1:length(celltype_list)){
  ct1=celltype_list[[i]]
  for (j in 1:length(celltype_list2)){
    ct2=celltype_list2[[j]]
...
setwd("D:/Projects/Large_scale_snRNA_seq/Brain_region_project/Brain_region_final/Evaluate_overlap_OteroGarcia/Permutation_test/nft/zscores_v2")
out_file=paste0("zscores_down_genes_",region,".csv")
...
p1=Heatmap(data,na_col = "#F0F0F0",
           ...
           cluster_rows = FALSE,cluster_columns = FALSE, col=colorRamp2(c(0, 2, 4),c("#4575b4", "#ffffbf", "#d73027")))
#################################################################
p1
setwd("D:/Projects/Large_scale_snRNA_seq/Brain_region_project/Brain_region_final/Evaluate_overlap_OteroGarcia/Permutation_test/nft/zscores_v2")
output_heatmap=paste0("zscores_down_genes_",region,".pdf")
