...
working_directory=paste0("D:/Projects/Large_scale_snRNA_seq/Brain_region_project/Brain_region_final/Evaluate_overlap_OteroGarcia/Permutation_test/nft/Random_gene_lists_up_DEGs/",region)
...
for (k in 1:length(celltype_list2)){
  ...
  working_directory=paste0("D:/Projects/Large_scale_snRNA_seq/Brain_region_project/Brain_region_final/Evaluate_overlap_OteroGarcia/Permutation_test/nft/Random_gene_lists_up_DEGs/Otero")
