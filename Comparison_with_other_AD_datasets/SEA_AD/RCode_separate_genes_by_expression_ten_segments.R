...
out_directory=paste0("D:/Projects/Large_scale_snRNA_seq/Brain_region_project/Brain_region_final/Evaluate_overlap_SEA_AD/Permutation_test/plaq_n/Random_gene_lists_up_DEGs/",region)
setwd(out_directory)
...
setwd("D:/Projects/Large_scale_snRNA_seq/Brain_region_project/Brain_region_final/Evaluate_overlap_SEA_AD/Permutation_test/plaq_n/Random_gene_lists_up_DEGs/SEAAD")
output_file=paste0(celltype,".csv")
write.csv(table,file=output_file)
####################################################################################
