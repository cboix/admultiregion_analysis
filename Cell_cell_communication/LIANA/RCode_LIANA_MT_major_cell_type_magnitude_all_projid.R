...
pbmc=readRDS("MT_merge_major_cell_type.rds")
...
setwd("F:/Brain_region_project/LIANA/Results_aggregate_rank_magnitude_all_projid")
write.csv(liana_test,file="MT.csv")