...
# Run as:
# sbatch --time=48:00:00 --array=2-139 $SBINDIR/differential_expression/calculate_degs/run_differential_02_MAST_selected_genes.sh
...
cmd="$RCMD --slave -f ${SCRIPTDIR}/run_differential_02_MAST_selected_genes.R --args $INFOFILE $TASK"
