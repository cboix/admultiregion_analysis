...
# Run as:
# sbatch --time=72:00:00 --array=1-450 $SBINDIR/differential_expression/calculate_degs/run_differential_01_NB_wRUV.sh
# sbatch --time=72:00:00 --array=450-668 $SBINDIR/differential_expression/calculate_degs/run_differential_01_NB_wRUV.sh
...
cmd="$RCMD --slave -f ${SCRIPTDIR}/run_differential_01_NB_wRUV.R --args $INFOFILE $TASK"
