...
for(i in 1:length(BR_list)){
  ...
  formula = ~gpath_CR_score_median + age_death + pmi + msex
  cd = as.data.frame(colData(pbmc.sce))
  cd2=cd[,c("gpath_CR_score_median","pmi","age_death","msex")]
  ...
  cond<-factor(colData(sca)$gpath_CR_score_median)
  ...
  write.csv(fcHurdle_All,"Ast_gpath_CR_score.csv")
  
  #########################################################
  #This part makes sure that individuals with NA values are excluded
  formula = ~plaq_n_CR_score_median + age_death + pmi + msex
  cd = as.data.frame(colData(pbmc.sce))
  cd2=cd[,c("plaq_n_CR_score_median","pmi","age_death","msex")]
  design=model.matrix(formula,cd2)
  ...
  cond<-factor(colData(sca)$plaq_n_CR_score_median)
  cond<-relevel(cond,"low")
  colData(sca)$condition<-cond
  zlmCond <- zlm(~condition + cngeneson + age_death + pmi + msex + (1|projid), sca, exprs_value = 'logcounts')
  ...
  setwd(paste0("G:/PFC_429_final_Spring2021/Vanshika/MAST/Results_Brain_Regions/",BR_list[i]))
  write.csv(fcHurdle_All,"Ast_plaq_n_CR_score.csv")
  
  #########################################################
  #This part makes sure that individuals with NA values are excluded
  formula = ~nft_CR_score_median + age_death + pmi + msex
  cd = as.data.frame(colData(pbmc.sce))
  cd2=cd[,c("nft_CR_score_median","pmi","age_death","msex")]
  design=model.matrix(formula,cd2)
  ...
  cond<-factor(colData(sca)$nft_CR_score_median)
  cond<-relevel(cond,"low")
  colData(sca)$condition<-cond
  zlmCond <- zlm(~condition + cngeneson + age_death + pmi + msex + (1|projid), sca, exprs_value = 'logcounts')
  ...
  setwd(paste0("G:/PFC_429_final_Spring2021/Vanshika/MAST/Results_Brain_Regions/",BR_list[i]))
  write.csv(fcHurdle_All,"Ast_nft_CR_score.csv")
  
  #########################################################
  #This part makes sure that individuals with NA values are excluded
  formula = ~tangles_CR_score_median + age_death + pmi + msex
  cd = as.data.frame(colData(pbmc.sce))
  cd2=cd[,c("tangles_CR_score_median","pmi","age_death","msex")]
  design=model.matrix(formula,cd2)
  ...
  cond<-factor(colData(sca)$tangles_CR_score_median)
  cond<-relevel(cond,"low")
  colData(sca)$condition<-cond
  zlmCond <- zlm(~condition + cngeneson + age_death + pmi + msex + (1|projid), sca, exprs_value = 'logcounts')
  ...
  setwd(paste0("G:/PFC_429_final_Spring2021/Vanshika/MAST/Results_Brain_Regions/",BR_list[i]))
  write.csv(fcHurdle_All,"Ast_tangles_CR_score.csv")
  
  #########################################################
  #This part makes sure that individuals with NA values are excluded
  formula = ~gpath_CDR_score_median + age_death + pmi + msex
  cd = as.data.frame(colData(pbmc.sce))
  cd2=cd[,c("gpath_CDR_score_median","pmi","age_death","msex")]
  design=model.matrix(formula,cd2)
  ...
  cond<-factor(colData(sca)$gpath_CDR_score_median)
  cond<-relevel(cond,"low")
  colData(sca)$condition<-cond
  zlmCond <- zlm(~condition + cngeneson + age_death + pmi + msex + (1|projid), sca, exprs_value = 'logcounts')
  ...
  setwd(paste0("G:/PFC_429_final_Spring2021/Vanshika/MAST/Results_Brain_Regions/",BR_list[i]))
  write.csv(fcHurdle_All,"Ast_gpath_CDR_score.csv")
  
  #########################################################
  #This part makes sure that individuals with NA values are excluded
  formula = ~plaq_n_CDR_score_median + age_death + pmi + msex
  cd = as.data.frame(colData(pbmc.sce))
  cd2=cd[,c("plaq_n_CDR_score_median","pmi","age_death","msex")]
  design=model.matrix(formula,cd2)
  ...
  cond<-factor(colData(sca)$plaq_n_CDR_score_median)
  cond<-relevel(cond,"low")
  colData(sca)$condition<-cond
  zlmCond <- zlm(~condition + cngeneson + age_death + pmi + msex + (1|projid), sca, exprs_value = 'logcounts')
  ...
  setwd(paste0("G:/PFC_429_final_Spring2021/Vanshika/MAST/Results_Brain_Regions/",BR_list[i]))
  write.csv(fcHurdle_All,"Ast_plaq_n_CDR_score.csv")
  
  #########################################################
  #This part makes sure that individuals with NA values are excluded
  formula = ~nft_CDR_score_median + age_death + pmi + msex
  cd = as.data.frame(colData(pbmc.sce))
  cd2=cd[,c("nft_CDR_score_median","pmi","age_death","msex")]
  design=model.matrix(formula,cd2)
  ...
  cond<-factor(colData(sca)$nft_CDR_score_median)
  cond<-relevel(cond,"low")
  colData(sca)$condition<-cond
  zlmCond <- zlm(~condition + cngeneson + age_death + pmi + msex + (1|projid), sca, exprs_value = 'logcounts')
  ...
  setwd(paste0("G:/PFC_429_final_Spring2021/Vanshika/MAST/Results_Brain_Regions/",BR_list[i]))
  write.csv(fcHurdle_All,"Ast_nft_CDR_score.csv")
  
  #########################################################
  #This part makes sure that individuals with NA values are excluded
  formula = ~tangles_CDR_score_median + age_death + pmi + msex
  cd = as.data.frame(colData(pbmc.sce))
  cd2=cd[,c("tangles_CDR_score_median","pmi","age_death","msex")]
  design=model.matrix(formula,cd2)
  ...
  cond<-factor(colData(sca)$tangles_CDR_score_median)
  cond<-relevel(cond,"low")
  colData(sca)$condition<-cond
  zlmCond <- zlm(~condition + cngeneson + age_death + pmi + msex + (1|projid), sca, exprs_value = 'logcounts')
  ...
  setwd(paste0("G:/PFC_429_final_Spring2021/Vanshika/MAST/Results_Brain_Regions/",BR_list[i]))
  write.csv(fcHurdle_All,"Ast_tangles_CDR_score.csv")
